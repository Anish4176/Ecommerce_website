  ...
  return (
    <div>
      <footer className={`text-gray-600 ${isdark ? 'text-white' : 'text-black'} ${isdark ? 'bg-black' : 'bg-gray-100'}  body-font mx-auto`}>
        <div className="container py-24 mx-auto flex justify-center md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64  md:mx-5 mx-auto text-end md:text-left">
            <Link href={"/"}>
          ...
          <div className="flex-grow flex flex-wrap  -mb-10 md:mt-0 mt-10 justify-center md:text-left text-center">
