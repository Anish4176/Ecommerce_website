            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-3 mt-6 lg:mt-0">
              ...
              {/* <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 text-maincolor" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                  </svg>
              ...
              <div className="flex">
                ...
                <button disabled={product.availableQty<=0} onClick={() => { addToCart(slug, 1, product.price,product.title ,product.color, product.size) }} className="flex ml-3 disabled:bg-submaincolor text-white bg-maincolor border-0 py-2 px-6 focus:outline-none hover:bg-maincolor rounded">Add to Cart</button>
