          ...
          <div className="lg:w-4/5 mx-auto flex justify-center flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-3 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button onClick={() => { addToCart(slug, 1, 499,product.title ,product.color, product.size) }} className="flex ml-3 text-white bg-maincolor border-0 py-2 px-6 focus:outline-none hover:bg-maincolor rounded">Add to Cart</button>
