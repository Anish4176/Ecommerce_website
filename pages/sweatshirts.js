...
function Sweatshirts({ sweatshirt }) {
  
if(sweatshirt == null){
  return <p className='text-center mt-10'>Sorry all the sweatshirts are out of stock. New stock coming soon. Stay tuned!</p>
}
  return (
    <div>
              ...
              return <Link key={sweatshirt[element]._id} href={`/product/${sweatshirt[element].slug}`}>
               ...
               rounded overflow-hidden">
                  ...
                  <div className="mt-4 mx-2">
                    ...
                    <h2 className="text-gray-900 title-font text-lg font-medium">{sweatshirt[element].title}</h2>
                    <p className="mt-1">₹{sweatshirt[element].price}</p>
                    ...
                    <p className="my-3 space-x-2">
                      {sweatshirt[element].size.includes('S') && <span className='border border-gray-600 p-1'>S</span> }
                      {sweatshirt[element].size.includes('M') && <span className='border border-gray-600  p-1'>M</span> }
                      {sweatshirt[element].size.includes('L') && <span className='border border-gray-600  p-1'>L</span> }
                      {sweatshirt[element].size.includes('XL') && <span className='border border-gray-600  p-1'>XL</span> }
                      {sweatshirt[element].size.includes('XXL') && <span className='border border-gray-600  p-1'>XXL</span> }
