          ...
          <div className="lg:w-1/4 md:w-1/2 p-2 mx-auto lg:mx-1 cursor-pointer shadow-md m-2">
            <Link href={'/product/wear-the-code'}>
             ...
             rounded overflow-hidden">
                <img alt="ecommerce" className="m-auto h-[40vh] w-[40vh] block" src="https://rukminim1.flixcart.com/image/416/416/xif0q/mousepad/8/v/a/mouse-pad-motivational-mouse-pade-good-vibe-mouse-pad-for-original-imaghmqqpxmkgcnb.jpeg?q=70" />
              </div>
