          ...
          <div className="lg:w-1/4 md:w-1/2 p-2 mx-auto lg:mx-1 cursor-pointer shadow-md m-2">
            <Link href={'/product/wear-the-code'}>
             ...
             rounded overflow-hidden">
                <img alt="ecommerce" className="m-auto h-[40vh] w-[40vh] block" src="https://rukminim1.flixcart.com/image/832/832/xif0q/kids-t-shirt/p/w/a/11-12-years-bd-s-5-dagcros-original-imagadgxsdt5bzx9-bb.jpeg?q=70" />
              </div>
